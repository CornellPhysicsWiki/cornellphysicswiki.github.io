...
There will be one problem set per week. Homework will be graded based on effort. For each problem set, a short quiz will be given in the first section after the problem set due date. The quiz can be one of the problems from the problem set with a modification, or it might be a problem came up by the TA. Quizzes will be graded based on correctness and effort. There are two prelims and a final. There are 3 lectures and 2 discussion sections per week. [Fall 2024]
...
## General Advice
  ...
  - Do not wait until the last minute to do problem sets. Study the Psets for the quiz before hand. Grind problem sets in the textbook to do well on exams as some are even harder than the exam questions. [Fall 2024]
...
I absolutely love this class. This class is very informative, much better than high school AP classes. It is a great introduction to mechanics, and special relativity is probably the best section. However, be sure to take time to study the materials well, as this class is also much more difficult than AP physics. Professor Perelstein's lectures and teaching are fantastic. He is very passionate and engaging. [Fall 2024]
...
| Fall 2024 | Maxim Perelstein | B+ | <a href="/syllabi/PHYS1116_FA24.pdf">PHYS1116_FA24.pdf</a> |